...
import HotelReviewNumber from "./HoteReviewCount";
    ...
    <>
      <div className={fromListPage ? "flex-1" : "flex-1 container"}>
        ...
        <div className="flex gap-2 items-center my-4">
          <HotelRating id={info?.id}></HotelRating>
          <HotelReviewNumber id={info?.id}></HotelReviewNumber>
          {info?.isBooked && <span className="text-orange-500 font-bold">Sold Out</span>}
        </div>
        <div>
          <span className="bg-yellow-300 p-1 px-2 rounded-md">
